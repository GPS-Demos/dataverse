...
resource "google_redis_instance" "redis_instance" {
  ...
  authorized_network      = resource.google_compute_network.default.self_link
  ...
  template {
    ...
    vpc_access {
      network_interfaces {
        ...
        subnetwork = resource.google_compute_subnetwork.default_subnet.name
      }
...
resource "google_cloud_run_service_iam_member" "dc_web_service_invoker" {
  ...
  member   = "group:rit-migration-team@2187502619001.altostrat.com"
